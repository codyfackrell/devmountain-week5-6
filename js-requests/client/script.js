...
function helloBtnStyle() { 
    sayHelloButton.classList.add('helloBtn')
}

sayHelloButton.addEventListener('mouseover', helloBtnStyle)
...
function originalHelloBtn() {
    sayHelloButton.classList.remove('helloBtn')
}

sayHelloButton.addEventListener('mouseout', originalHelloBtn)
